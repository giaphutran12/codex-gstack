...
## Full-Skill Design Shotgun Agents

Whenever this skill dispatches any design variant, reviewer, verifier, Codex-style
agent, or design subagent, the prompt MUST instruct that agent to first read the full
skill file at `$GSTACK_ROOT/design-shotgun/SKILL.md`.

Use this prefix:

> IMPORTANT: First read the full design-shotgun skill file at `$GSTACK_ROOT/design-shotgun/SKILL.md`. Do NOT read or execute any other SKILL.md files or skill definition directories. Stay focused on this named skill, the design brief, generated variants, and repository code only.

This prevents shallow variant prompts and guarantees design agents use the full
design-shotgun methodology.
